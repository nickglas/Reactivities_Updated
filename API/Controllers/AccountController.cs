...
namespace API.Controllers
{
    ...
    public class AccountController : ControllerBase
    {
        ...
        public async Task<ActionResult<UserDto>> Login(LoginDto loginDto)
        {
            ...
            return Unauthorized("Combination of email and password is not valid");
        }
        ...
        public async Task<ActionResult<UserDto>> Register(RegisterDto registerDto)
        {
            ...
            if (!result.Succeeded) return BadRequest("Problem creating new user account");
        ...
        public async Task<IActionResult> VerifyEmail(string token, string email)
        {
            ...
            var decodedTokenByes = WebEncoders.Base64UrlDecode(token);
            var decodedToken = Encoding.UTF8.GetString(decodedTokenByes);
        ...
        public async Task<IActionResult> ResendVerifyEmail(string email)
        {
            ...
            return Ok("Email verification email send - please verify email");
        }
